...
/*
    ...
    ^ Team: Alone
    ^ Version : V.1
    ^ YT : https://www.youtube.com/channel/UCN2GrmWH8QQsMrtQbWKQzbg
...
$MyPass = 'cabul'; // Password Default: PURWOKERTO20
